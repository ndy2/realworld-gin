...
func GetProfileHandler(l *Logic) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		logger.Log.Info("Getting profile", zap.String("username", currentUsername.(string)), zap.Int("profileId", profileId.(int)))
		...
		logger.Log.Info("Got profile", zap.String("username", resp.Username))
